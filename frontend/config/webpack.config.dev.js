...
module.exports = {
  ...
  entry: [
    ...
    // module.resolve('webpack-dev-server/client') + '?/',
    // module.resolve('webpack/hot/dev-server'),
  ...
  output: {
    ...
    path: paths.appBuild,
    // Add /* filename */ comments to generated module()s in the output.
    pathinfo: true,
  ...
  plugins: [
    ...
    // If you module a missing module and then `npm install` it, you still have
